...
PO4_ANGLES = {
    ...
    "PO4==AS_0": [
        AngleDefinition("PO4==AS_0", "OP1", "P", "OP2", 0, 0, 0, 119.9, 1.6,   119.7, 1.5, 111.9, 127.5, 103.3, 133.7),
        AngleDefinition("PO4==AS_0", "OP1", "P", "O3'", 0, 0, -1, 104.5, 0.9,  107.6, 2.0, 97.3, 116.8, 86.2, 124.1),
        AngleDefinition("PO4==AS_0", "OP1", "P", "O5'", 0, 0, 0, 110.3, 0.8,   108.4, 2.0, 99.0, 117.2, 92.1, 124.2),
        AngleDefinition("PO4==AS_0", "OP2", "P", "O3'", 0, 0, -1, 111.5, 1.1,  108.4, 1.9, 100.0, 118.1, 90.7, 124.8),
        AngleDefinition("PO4==AS_0", "OP2", "P", "O5'", 0, 0, 0, 105.2, 0.8,   108.0, 2.1, 98.0, 117.2, 90.3, 124.4),
        AngleDefinition("PO4==AS_0", "O3'", "P", "O5'", -1, 0, 0, 104.2, 1.5,  103.6, 1.0, 98.9, 107.3, 87.9, 115.0),
        AngleDefinition("PO4==AS_0", "P", "O3'", "C3'", 0, -1, -1, 121.5, 3.0, 120.0, 1.2, 112.8, 126.1, 105.5, 133.0),
        AngleDefinition("PO4==AS_0", "P", "O5'", "C5'", 0, 0, 0, 121.6, 2.8,   120.5, 1.0, 115.3, 124.5, 110.2, 129.5),
    ],
    "PO4==AS_1": [
        AngleDefinition("PO4==AS_1", "OP1", "P", "OP2", 0, 0, 0, 119.9, 1.6,   119.7, 1.5, 111.9, 127.5, 103.3, 133.7),
        AngleDefinition("PO4==AS_1", "OP1", "P", "O3'", 0, 0, -1, 105.2, 0.8,  107.6, 2.0, 97.3, 116.8, 86.2, 124.1),
        AngleDefinition("PO4==AS_1", "OP1", "P", "O5'", 0, 0, 0, 111.5, 1.1,   108.4, 2.0, 99.0, 117.2, 92.1, 124.2),
        AngleDefinition("PO4==AS_1", "OP2", "P", "O3'", 0, 0, -1, 110.3, 0.8,  108.4, 1.9, 100.0, 118.1, 90.7, 124.8),
        AngleDefinition("PO4==AS_1", "OP2", "P", "O5'", 0, 0, 0, 104.5, 0.9,   108.0, 2.1, 98.0, 117.2, 90.3, 124.4),
        AngleDefinition("PO4==AS_1", "O3'", "P", "O5'", -1, 0, 0, 104.2, 1.5,  103.6, 1.0, 98.9, 107.3, 87.9, 115.0),
        AngleDefinition("PO4==AS_1", "P", "O3'", "C3'", 0, -1, -1, 121.6, 2.8, 120.0, 1.2, 112.8, 126.1, 105.5, 133.0),
        AngleDefinition("PO4==AS_1", "P", "O5'", "C5'", 0, 0, 0, 121.5, 3.0,   120.5, 1.0, 115.3, 124.5, 110.2, 129.5),
    ],
    "PO4==AS_2": [
